...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1, maximum-scale=1"}],"link":[],"style":[],"script":[],"noscript":[],"titleTemplate":"%s - POS BOS"};
...
const entryFileName = "B3vlrJjU.js";
