  ...
  <div class="w-full max-w-6xl p-6 sm:p-8 bg-white rounded-2xl shadow-xl border border-gray-100 flex flex-col gap-6 relative">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
      ...
      <div class="p-6 bg-emerald-50 rounded-xl border border-emerald-100 shadow-sm relative overflow-hidden group hover:shadow-md transition-all">
        ...
        <h3 class="text-sm font-medium text-emerald-800">Pesanan Baru</h3>
        <p class="text-3xl font-bold text-emerald-950 mt-2">{{ isLoading ? '...' : summary.new_orders }}</p>
      </div>
      ...
      <div class="p-6 bg-emerald-50 rounded-xl border border-emerald-100 shadow-sm relative overflow-hidden group hover:shadow-md transition-all">
        ...
        <h3 class="text-sm font-medium text-emerald-800">Produk Terjual</h3>
        <p class="text-3xl font-bold text-emerald-950 mt-2">{{ isLoading ? '...' : summary.products_sold }}</p>
      </div>
    </div>
  </div>
</template>
